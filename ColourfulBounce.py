...
while not exit:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            sp1.change_colour(random.choice([YELLOW, MAGENTA, ORANGE, WHITE]))
...
pygame.quit()
print("fffffffffffffffffffffffffffffffffffffffffffffffffffxxxxsxsxsxddsdddddxddddddddxsezzxxxxxxxxxxxxxxzxzeeeeeeeeeeeeweeeeeeeeewewwwwwwwwwwwwwwwweeeeeeeeeeeee3edsssxsz\\\\\dzxxsxszxzzsxzzsszsssssssdsssssssssssssssssssssssssssssssssxsdddddddddddsssssssssssssssxssdsxsxsxsdddddddd2222222222211111111111111111111111112222\\cvc c vccccvvvvvvvvvvvvvvcv                                                     c")